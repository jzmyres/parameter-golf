...
| num_heads | 8 |
| num_kv_heads | 4 |
| num_experts | 24 (iter 97: 16 → 24 — extending the validated iter 96 "more, smaller experts" axis) |
...
| attn_expert_rank | 42 (iter 97: 64 → 42; iso-cost on Q linears as E×1.5: 16·64=1024 → 24·42≈1008) |
| mlp_expert_rank | 64 (iter 97: 96 → 64; iso-cost on MLP linears as E×1.5: 16·96=1536 → 24·64=1536) |
