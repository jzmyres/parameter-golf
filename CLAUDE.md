...
- **Router health:** `router_entropy_coef=0.1` ON (default collapse-preventer); load-balance off by default (decouple antagonistic regs); `lambda_route` adaptive for the relu router (`moe_target_active_frac=0.5`).
