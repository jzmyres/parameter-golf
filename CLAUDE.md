...
- **Default-off paths:** `num_refinements=0`, `use_ctp=False`, `use_nsa_attention=False`, `lyapunov_coef=0`, `denoising_coef=0`, `mos_output_diversity_coef=0`, `logit_softcap=0`, `bigram_vocab_size=0`, `deq_prefix_anchors=False` (iter152: enables conditional prefix-K multi-anchor task supervision; promoted on BPB but kept opt-in due to local-contraction debt).
