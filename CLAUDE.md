...
| deq_k_jitter_set | (32, 48) (iter 131 retry 2026-05-03: doubled from (16,24); first attempt killed at s600 by overly-strict +0.05 trigger — re-running with +0.5 trigger to obtain full s1000 verdict) |
