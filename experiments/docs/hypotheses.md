...
- **Lyapunov/operator-norm soft penalties refuted as not principled
  ...
  fail at promotion, escalate to formal-tier mechanisms (spectral
  normalization on $T_\theta$ component layers, bounded-Lipschitz
  block parameterization) --- not soft penalties.
