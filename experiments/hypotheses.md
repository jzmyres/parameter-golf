...
| 71e | Re-enable FSQ, no bounding | FSQ with round+STE, integer levels [-3,3], no tanh | H59 | **REVERTED** (+0.114, FSQ hurts at WD=0.30. STE gradient noise > quant gap benefit) | 1.6395 | — |
| 71f | ~~FSQ with clamp(-1,1)~~ | ~~Cancelled: FSQ clearly harmful at WD=0.30~~ | H59 | CANCELLED | — | — |
