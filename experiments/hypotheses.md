...
| 21-retry-4 | repro test: HEAD code (val_bpb-primary + H32 ortho loss removed) | running | TBD — disambiguates: bf16 noise vs real regression | if 1.67-ish: noise; if ~1.89: confirms regression, root-cause needed |
