...
| 66a | Parcae per-dim Ā (tied B̄=1-Ā) | x_{t+1}=Ā·x_t+(1-Ā)·f(x_t,x0), Ā=exp(Δ·(-exp(log_a)))∈(0,1) | H48/Parcae | **CRASHED** (DDP unused params + zero gradients; fixed: grad_beta in RevDEQ backward) | — | — |
