...
12. **Iter 97.7** — PROFILE-driven throughput retry (proper chrome-trace + fix top 5 bottlenecks).
13. **Iter 95** — TBPTT efficiency sweep (jitter set `(1, 2, 3, 4, 5, 6, 8, 12)` + post-train elbow analysis).
