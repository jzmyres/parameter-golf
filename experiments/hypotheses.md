...
| 74f | Independent shared gates (attn vs mlp) | Fix 1-dim shared gate → 2-dim for independent control | arch | **REVERTED** (+0.011, extra gate freedom not utilized) | 1.5257 | — |
