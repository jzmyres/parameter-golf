...
class TestOptimizerCoverage(unittest.TestCase):
    def test_all_trainable_parameters_are_grouped_once(self) -> None:
        ...
        for name in [
            ...
            # Iter 90 layout: BottleneckIn → ExpertMLABody → BottleneckOut.
            "shared_block.attn.in_proj.in_down_norm_weight",
            "shared_block.attn.in_proj.in_up_norm_weight",
            "shared_block.attn.out_proj.out_down_norm_weight",
            "shared_block.attn.out_proj.out_up_norm_weight",
            "shared_block.attn.expert_body.q_in_norm_weight",
            "shared_block.attn.expert_body.kv_a_in_norm_weight",
            "shared_block.attn.expert_body.k_nope_in_norm_weight",
            "shared_block.attn.expert_body.v_in_norm_weight",
            "shared_block.attn.expert_body.kr_in_norm_weight",
            "shared_block.attn.expert_body.wo_in_norm_weight",
            "shared_block.mlp.in_proj.in_down_norm_weight",
            "shared_block.mlp.expert_body.gate_in_norm_weight",
            "shared_block.mlp.expert_body.fc_in_norm_weight",
            "shared_block.mlp.expert_body.hidden_norm_weight",
            "shared_block.mlp.expert_body.down_in_norm_weight",
            "shared_block.mlp.out_proj.out_down_norm_weight",
            "shared_block.mlp.out_proj.out_up_norm_weight",
        ]:
