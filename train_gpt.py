...
class Hyperparameters:
    ...
    num_kv_heads = int(os.environ.get("NUM_KV_HEADS", 8))  # Full MHA — MLA already compresses KV
    ...
    kv_latent_dim = int(os.environ.get("KV_LATENT_DIM", 256))  # Reduced latent with full MHA
