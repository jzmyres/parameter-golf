...
class Hyperparameters:
    ...
    matrix_lr = float(os.environ.get("MATRIX_LR", 0.20))
    scalar_lr = float(os.environ.get("SCALAR_LR", 0.20))
...
class CausalSelfAttention(nn.Module):
    def __init__(self, dim: int, num_heads: int, num_kv_heads: int, rope_base: float, qk_gain_init: float):
        ...
        # Gated attention: per-head sigmoid gate, init=3.0 (starts ~0.95 open)
